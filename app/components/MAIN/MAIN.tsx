      ...
      <main id="content" role="main">
        ...
        <div className="grid h-15 max-w-lg grid-cols-5 mx-auto">
          <button
            ...
            type="button"
            data-tab="001"
            className={`inline-flex flex-col items-center justify-center p-3 ${
              activeTab === '001'
            }`}
            onClick={() => changeActiveTab('001')}
          >
            <div className="h-6 w-6">
              <svg className="w-[25px] h-[25px] fill-[#81d8d0] hover:fill-[#6b7280]" viewBox="0 0 576 576" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <div className="h-6 w-6">
              <svg className="w-[25px] h-[25px] fill-[#81d8d0] hover:fill-[#6b7280]" viewBox="0 0 476 576" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          >
            ...
            <div className='w-full flex flex-col items-center'>
              <a>1ページ目</a>
              <div className="text-lg">最終更新:02.11/17:25</div>
