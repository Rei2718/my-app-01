  ...
  return (
    <>
      <main id="content" role="main">
        ...
        <div className="bg-fixed flex items-center justify-center" style={{ backgroundImage: 'url("bg_water.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', height: '100svh' }}>
