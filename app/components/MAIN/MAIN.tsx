  ...
  return (
    <>
      <main id="content" role="main">
        ...
        <div className="bg-fixed h-screen flex justify-center" style={{ backgroundImage: 'url("bg_water.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', width: "110svh" }}>
